...
namespace NKikimr::NArrow::NSerialization {
    ...
    NKikimr::TConclusion<std::shared_ptr<arrow::util::Codec>> TGorillaSerializer::BuildCodec(const arrow::Compression::type& cType, const std::optional<ui32> level) const {
